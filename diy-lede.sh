...
git clone -b lede https://github.com/updateing/minieap.git package/minieap  #minieap校园网认证_新
git clone -b lede https://github.com/hyrathb/mentohust.git package/mentohust  #mentohust校园网认证加入V4
